...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        paint.setColor(Color.parseColor("#FF8E30"));
    }
...
//			drawCenterRect(canvas);
        ...
        canvas.drawLine(3 * PADDING, itemHeight * 19 / 10, getWidth() - 3 * PADDING, itemHeight * 19 / 10, paint);
        canvas.drawLine(3 * PADDING, itemHeight * 29 / 10, getWidth() - 3 * PADDING, itemHeight * 29 / 10, paint);
