...
//		setBackgroundResource(R.drawable.wheel_bg);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(3 * PADDING, itemHeight * 25 / 10, getWidth() - 3 * PADDING, itemHeight * 25 / 10, paint);
        canvas.drawLine(3 * PADDING, itemHeight * 35 / 10, getWidth() - 3 * PADDING, itemHeight * 35 / 10, paint);
    }
